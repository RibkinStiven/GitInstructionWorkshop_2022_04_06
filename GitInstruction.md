...
1. На удаленном репозитории выолнить fork

2. Клонировать на локальный репозиторий, git clone \<url-адрес репозитория> – клонирование внешнего репозитория на  локальный ПК

3. Перейти в папку репозитория можно двумя способами:

* GitInstructionWorkshop_2022_04_06 - правой кнопкой мыши вызвать - Open in interated Terminal$

* Командой  - cd .\GitInstructionWorkshop_2022_04_06\  

* Выполнить git add, git commit
